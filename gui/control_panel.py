# ===================================================================================
# ### gui/control_panel.py (V3.0 - 终极简化版) ###
# ===================================================================================
...
class AwsAutomationApp:
    def __init__(self, root):
        self.root = root
        self.root.title("AWS自动化控制面板 V3.0 (终极版)")
        ...
        ttk.Label(frame1, text="目标国家代码(2字母):").grid(row=2, column=0, sticky="w", padx=5, pady=2)
    ...
    def fetch_data_thread(self, url):
        ...
        try:
            response = requests.get(url, timeout=60) # 延长超时时间以备数据量大
